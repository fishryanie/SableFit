  ...
  return (
    <ReviewDashboard
      ...
      dictionary={{
        ...
        editMedia: t("editMedia"),
        editMediaDescription: t("editMediaDescription"),
        currentImage: t("currentImage"),
        currentVideo: t("currentVideo"),
        currentPath: t("currentPath"),
        customMedia: t("customMedia"),
        defaultMedia: t("defaultMedia"),
        sourcePathLabel: t("sourcePathLabel"),
        sourcePathPlaceholder: t("sourcePathPlaceholder"),
        sourcePathHelp: t("sourcePathHelp"),
        targetDirectory: t("targetDirectory"),
        saveImage: t("saveImage"),
        saveVideo: t("saveVideo"),
        removeImage: t("removeImage"),
        removeVideo: t("removeVideo"),
        noVideo: t("noVideo"),
        saving: t("saving"),
